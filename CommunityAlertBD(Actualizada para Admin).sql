...
INSERT INTO `categoriapublicacion` VALUES (1,'Categoria #1'),(2,'Categoria #2'),(3,'Categoria #3'),(4,'Categoria #4');
...
INSERT INTO `comentarios` VALUES (1,'Ejemplo de comentario #1','2024-07-26 16:14:21',1,2),(2,'Ejemplo de comentario #2','2024-07-26 16:14:30',1,2),(3,'Ejemplo de comentario #3','2024-07-26 16:14:42',1,2),(4,'Ejemplo de comentario #1','2024-07-26 16:15:07',2,1),(5,'Ejemplo de comentario #2','2024-07-26 16:15:12',2,1);
...
INSERT INTO `publicaciones` VALUES (1,'Ejemplo de publicación #1','Ejemplo de contenido','2024-07-26 00:00:00',1,1),(2,'Ejemplo de publicación #2','Ejemplo de contenido','2024-07-26 00:00:00',2,2),(3,'Ejemplo de publicación #3','Ejemplo de contenido','2024-07-26 00:00:00',2,3);
...
INSERT INTO `usuarios` VALUES (1,'402620226','RICARDO AARON VARGAS MONTERO','ricardovm2803@gmail.com','Masculino','123','Estoy usando Community Alert!','https://static.vecteezy.com/system/resources/previews/007/409/979/non_2x/people-icon-design-avatar-icon-person-icons-people-icons-are-set-in-trendy-flat-style-user-icon-set-vector.jpg','2024-07-25 11:44:38',2,300,_binary ''),(2,'117310079','JESUS DANIEL VEGA MARVEZ','jvega10079@ufide.ac.cr','Masculino','123','Estoy usando Community Alert!','https://static.vecteezy.com/system/resources/previews/007/409/979/non_2x/people-icon-design-avatar-icon-person-icons-people-icons-are-set-in-trendy-flat-style-user-icon-set-vector.jpg','2024-07-25 11:55:14',1,122,_binary '');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ObtenerNoticia`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PublicarNoticia`(IN ptitulo VARCHAR(70), IN pcontenido VARCHAR(255), IN pusuario INT, IN pcategoria INT)
BEGIN
...
-- Dump completed on 2024-07-26 17:36:12
