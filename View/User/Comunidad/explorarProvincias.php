                ...
                <div class="page-inner">
                    <div class="page-inner-top">
                        <div class="mt-2 mb-4 d-flex flex-column">
                            ...
                            <span class="display-5 pl-2">Selecciona tu provincia para poder encontrar tu comunidad!</span>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-3">
                                    <a href="#" style="text-decoration: none; color: inherit;">
                                        <div class="d-flex justify-content-between">
                                            <div class="container w-75 pl-0 pr-0 ml-0 mr-0">
                                                <h1 class="h1 mb-0">Cartago</h1>
                                                <div class="display-5">Bienvenido a Santo Domingo, mantente al tanto de las noticias más relevantes de la zona</div>
                                            </div>
                                            <div class="d-flex flex-column justify-content-between mr-3">
                                                <div>
                                                    <i class="fa fa-users"></i>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-3">
                                    <a href="#" style="text-decoration: none; color: inherit;">
                                        <div class="d-flex justify-content-between">
                                            <div class="container w-75 pl-0 pr-0 ml-0 mr-0">
                                                <h1 class="h1 mb-0">Guanacaste</h1>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-3">
                                    <a href="#" style="text-decoration: none; color: inherit;">
                                        <div class="d-flex justify-content-between">
                                            <div class="container w-75 pl-0 pr-0 ml-0 mr-0">
                                                <h1 class="h1 mb-0">Puntarenas</h1>
                                                <div class="display-5">Descubre las noticias más recientes de San Pablo, un distrito con una rica historia y cultura</div>
                                            </div>
                                            <div class="d-flex flex-column justify-content-between mr-3">
                                                <div>
